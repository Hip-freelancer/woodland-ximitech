...
export default function HeroSection() {
  ...
  return (
    <section className="relative -mt-16 h-screen w-full flex items-center overflow-hidden grain-overlay bg-primary">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-12 w-full pt-14 md:pt-16">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-wrap gap-6">
            <Link
              href="/products"
              className="flex items-center gap-2 bg-surface text-primary px-10 py-5 font-headline font-bold uppercase text-sm tracking-widest hover:bg-secondary hover:text-on-secondary transition-all duration-500 ease-out"
            >
              {t("viewProducts")}
              <ArrowRight size={14} />
            </Link>
            <Link
              href="/about"
              className="border border-outline text-on-primary px-10 py-5 font-headline font-bold uppercase text-sm tracking-widest hover:bg-white/10 transition-all duration-500"
            >
              {t("ourProcess")}
            </Link>
          </div>
