...
export default function HistoryTimelineSection() {
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-6 py-24">
      <h2 className="font-headline font-black text-4xl uppercase text-[#331917] leading-none tracking-tight mb-16">
        {t("title")}
      </h2>

      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-px bg-[#e4e2e1] ml-4 md:ml-8" />
        ...
        <div className="flex flex-col gap-16">
          {milestones.map(({ year }, i) => (
            ...
            >
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 md:w-16 md:h-16 rounded-full bg-[#331917] flex items-center justify-center z-10">
              ...
              >
                <p className="font-headline font-black text-4xl text-[#e4e2e1] mb-2">
                  {year}
                </p>
