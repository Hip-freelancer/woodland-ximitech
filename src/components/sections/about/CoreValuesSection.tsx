  ...
  return (
    <section className="bg-surface-container-low py-24">
      <div className="max-w-[1440px] mx-auto px-6">
        <h2 className="font-headline font-black text-4xl uppercase text-primary leading-none tracking-tight mb-16 text-center">
          {t("title")}
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {valueKeys.map((key, i) => (
            <div key={key} className="bg-white p-10 text-center">
              <div className="text-secondary flex justify-center mb-6">{icons[i]}</div>
