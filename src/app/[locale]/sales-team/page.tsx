...
function TechnicalSupportSection() {
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-6 py-16">
      <div className="bg-[#f5f3f2] p-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h2 className="font-headline font-bold text-2xl uppercase text-[#331917] tracking-wide mb-2">
            {t("title")}
          </h2>
          <p className="font-body text-sm text-[#534340]">{t("subtitle")}</p>
        </div>
        <Link
          href="/contact"
          className="flex items-center gap-2 bg-[#331917] text-white font-label text-xs font-semibold uppercase tracking-widest px-8 py-4 hover:bg-[#4b2e2b] transition-colors duration-300 whitespace-nowrap"
        >
          {t("button")}
          <ArrowRight size={14} />
        </Link>
